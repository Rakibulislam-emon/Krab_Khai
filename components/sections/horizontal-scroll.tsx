...
export function HorizontalScroll({ items, className }: HorizontalScrollProps) {
  ...
  useEffect(() => {
    ...
    // We want to move the section to the left by (total width - viewport width)
  ...
  return (
    <section
      ref={triggerRef}
      className={cn("overflow-hidden h-screen bg-soft-pearl", className)}
    >
      <div
        ref={sectionRef}
        className="h-full flex items-center px-[50vw] w-fit" // Added padding to center first item effectively
      >
